...
# ----------------------------------------- ROW 2 --------------------------------------------------------
col1, col2 = st.columns(2) # Membagi tampilan menjadai 2 kolom
...
col1.plotly_chart(plot_join, use_container_width=True)  # use_container_width u/ menyesuaikan dgn lebar columns
...
# Bukan st. tetapi col2. untuk dimasukan ke bagian yg sudah dibuat di bagian kanan
col2.write('### Employee Count Across Indonesia')
col2.plotly_chart(plot_map, use_container_width=True)  # use_container_width u/ menyesuaikan dgn lebar columns
...
col5.write(f'### Employee Count per Generation in {input_select} Dept.') # gunakan f-string
